...
class UtilsMixin(AvdFacts):
    ...
    @cached_property
    def _mlag_peer_ipv6_pool(self) -> str:
    ...
    @cached_property
    def _loopback_ipv4_address(self) -> str | None:
    ...
    @cached_property
    def _vtep_loopback_ipv4_address(self) -> str | None:
    ...
    @cached_property
    def _mlag_odd_id_based_offset(self) -> int:
        """
    ...
    def _get_downlink_ipv4_pool_and_offset(self, uplink_switch_index: int) -> tuple[str, int]:
        """
    ...
    def _get_p2p_ipv4_pool_and_offset(self, uplink_switch_index: int) -> tuple[str, int]:
        """
