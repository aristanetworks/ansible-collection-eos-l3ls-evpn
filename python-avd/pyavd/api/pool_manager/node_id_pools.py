...
class NodeIdPoolCollection(PoolCollection[NodeIdPoolKey, NodeIdAssignmentKey, int]):
    ...
    @staticmethod
    def _pool_key_from_shared_utils(shared_utils: SharedUtils) -> NodeIdPoolKey:
    ...
    @staticmethod
    def _assignment_key_from_shared_utils(shared_utils: SharedUtils) -> NodeIdAssignmentKey:
