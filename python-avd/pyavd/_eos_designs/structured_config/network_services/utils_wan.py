...
class UtilsWanMixin(UtilsZscalerMixin, StructuredConfigGenerator):
    """
    ...
    @cached_property
    def _filtered_wan_vrfs(self) -> EosDesigns.WanVirtualTopologies.Vrfs:
    ...
    @cached_property
    def _wan_virtual_topologies_policies(self) -> EosDesigns.WanVirtualTopologies.Policies:
    ...
    @cached_property
    def _default_policy_path_group_names(self) -> list[str]:
        """
    ...
    @cached_property
    def _default_wan_policy(self) -> EosDesigns.WanVirtualTopologies.PoliciesItem:
        """
    ...
    @cached_property
    def _wan_control_plane_virtual_topology(self) -> EosDesigns.WanVirtualTopologies.ControlPlaneVirtualTopology:
        """
    ...
    def get_internet_exit_nat_acl_name(self, internet_exit_policy_type: Literal["zscaler", "direct"]) -> str:
    ...
    @cached_property
    def _l3_interface_acls(self) -> dict | None:
        """
    ...
    def _get_ipsec_credentials(self, internet_exit_policy: EosDesigns.CvPathfinderInternetExitPoliciesItem) -> tuple[str, str]:
