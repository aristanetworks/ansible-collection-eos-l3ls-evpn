...
class SnmpServerMixin(UtilsMixin):
    ...
    def _snmp_engine_ids(self, snmp_settings: EosDesigns.SnmpSettings) -> dict | None:
        """
    ...
    def _snmp_location(self, snmp_settings: EosDesigns.SnmpSettings) -> str | None:
        """
    ...
    def _snmp_users(self, snmp_settings: EosDesigns.SnmpSettings, engine_ids: dict | None) -> list | None:
        """
    ...
    def _snmp_hosts(self, snmp_settings: EosDesigns.SnmpSettings) -> EosCliConfigGen.SnmpServer.Hosts:
        """
    ...
    def _snmp_local_interfaces(self, source_interfaces_inputs: EosDesigns.SourceInterfaces.Snmp) -> list | None:
        """
    ...
    def _snmp_vrfs(self, snmp_settings: EosDesigns.SnmpSettings) -> EosDesigns.SnmpSettings.Vrfs:
        """
