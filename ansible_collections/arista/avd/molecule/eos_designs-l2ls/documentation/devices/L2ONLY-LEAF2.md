...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_L2ONLY-SPINE1_Ethernet2 | *trunk | *100,4092 | *- | *- | 1 |
| Ethernet2 | L2_L2ONLY-SPINE2_Ethernet2 | *trunk | *100,4092 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_L2ONLY-SPINE1_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description L2_L2ONLY-SPINE2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
