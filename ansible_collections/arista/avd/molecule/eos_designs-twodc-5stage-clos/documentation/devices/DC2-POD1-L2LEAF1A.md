...
| ------- | -------- | ---------- | ----- |
| - | TWODC_5STAGE_CLOS DC2 DC2_POD1 DC2-POD1-L2LEAF1A | All | Disabled |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | L2_DC2-POD1-LEAF1A_Ethernet3 | *trunk | *4092 | *- | *- | 1 |
...
!
interface Ethernet1
   description L2_DC2-POD1-LEAF1A_Ethernet3
   no shutdown
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | L2_DC2-POD1-LEAF1A_Port-Channel3 | trunk | 4092 | - | - | - | - | - | - |
...
interface Port-Channel1
   description L2_DC2-POD1-LEAF1A_Port-Channel3
   no shutdown
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4092 |  default  |  172.21.210.4/24  |  -  |  -  |  -  |  -  |
