...
- AvdTestInterfacesState
  - VerifyInterfacesStatus: Validate interfaces status. To skip tests for specific interfaces, set validate_state to False in the adapter configuration.
    - Ethernet interfaces
...
- AvdTestLLDPTopology
  - VerifyLLDPNeighbors: Validate LLDP topology. To skip tests for specific Ethernet interfaces, set validate_state to False in the adapter configuration.
