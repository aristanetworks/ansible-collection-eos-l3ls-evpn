...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;mac_timestamp</samp>](## "ethernet_interfaces.[].mac_timestamp") | String |  |  | Valid Values:<br>- <code>before-fcs</code><br>- <code>replace-fcs</code><br>- <code>header</code> | header: Insert timestamp in ethernet header. Supports on platforms like 7500E/R and 7280E/R.<br>before-fcs: Insert timestamp before fcs field. Support on platforms like 7150.<br>replace-fcs: Replace fcs field with timestamp. |
