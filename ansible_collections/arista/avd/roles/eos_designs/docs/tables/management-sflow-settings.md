...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;polling_interval</samp>](## "sflow_settings.polling_interval") | Integer |  |  | Min: 1 <br>Max: 3600| Interval in seconds for sending counter data to the sFlow collector |
