...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;sample</samp>](## "sflow_settings.polling_interval") | Integer |  |  | Min: 1<br>Max: 3600 | Interval for sending counter data to the sFlow collector |
