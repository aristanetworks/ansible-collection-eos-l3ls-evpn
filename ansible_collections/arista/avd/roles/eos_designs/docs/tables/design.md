...
=== "Table"
    ...
    | -------- | ---- | -------- | ------- | ------------------ | ----------- |
    | [<samp>design</samp>](## "design") <span style="color:red">deprecated</span> | Dictionary |  |  |  | <span style="color:red">This key is deprecated. Support will be removed in AVD version 6.0.0. See [here](https://avd.arista.com/stable/docs/porting-guides/5.x.x.html#deprecation-of-designtype) for details.</span> |
...
=== "YAML"
    ...
    # See [here](https://avd.arista.com/stable/docs/porting-guides/5.x.x.html#deprecation-of-designtype) for details.
    design:
