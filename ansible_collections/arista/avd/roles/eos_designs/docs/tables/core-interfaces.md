...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;role</samp>](## "core_interfaces.p2p_links_profiles.[].ptp.role") | String |  | `dynamic` | Valid Values:<br>- <code>dynamic</code><br>- <code>master</code> | AVD and EOS default is `dynamic`. |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;role</samp>](## "core_interfaces.p2p_links.[].ptp.role") | String |  | `dynamic` | Valid Values:<br>- <code>dynamic</code><br>- <code>master</code> | AVD and EOS default is `dynamic`. |
      ...
      p2p_links_profiles:
        ...
        - name: <str; required; unique>
          ...
          ptp:
            ...
            # AVD and EOS default is `dynamic`.
            role: <str; "dynamic" | "master"; default="dynamic">
