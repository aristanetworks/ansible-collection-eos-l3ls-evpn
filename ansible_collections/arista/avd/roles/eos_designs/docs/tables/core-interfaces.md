...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;role</samp>](## "core_interfaces.p2p_links_profiles.[].ptp.role") | String |  | `bmca` | Valid Values:<br>- <code>bmca</code><br>- <code>master</code> |  |
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;role</samp>](## "core_interfaces.p2p_links.[].ptp.role") | String |  | `bmca` | Valid Values:<br>- <code>bmca</code><br>- <code>master</code> |  |
      ...
      p2p_links_profiles:
        ...
        - name: <str; required; unique>
          ...
          ptp:
            ...
            role: <str; "bmca" | "master"; default="bmca">
