...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;platforms</samp>](## "network_ports.[].platforms") | List, items: String |  |  | Min Length: 1 | Matching the platform type of one or more switches. If you need to add custom platforms to match specific port quantities, create them under `custom_platform_settings`.<br>Entries under `custom_platform_settings` should match the platform match criteria.<br>For example, `720XP-48Y6` would require a custom platform type:<br><br>platforms:<br>  - 720XP<br>  - 720XP-48Y6<br> |
