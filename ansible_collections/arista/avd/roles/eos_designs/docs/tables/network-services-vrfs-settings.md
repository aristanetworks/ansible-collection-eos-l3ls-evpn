...
=== "Table"
    ...
    | [<samp>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;router_id</samp>](## "<network_services_keys.name>.[].vrfs.[].bgp.router_id") | String |  | `main_router_id` |  | Router ID to use for BGP in this VRF.<br>This can be an IP address, "main_router_id", "none", "vtep_diagnostic"<br>- "main_router_id" will reuse the main BGP Router ID which is the IP address of Loopback0.<br>- "none" will not configure a BGP Router ID for this VRF. EOS will use the main BGP Router ID.<br>- "vtep_diagnostic" will use the IP address of the VRF Diagnostic Loopback interface. |
