...
| WAN | overlay-controller | site1-rs1 | 192.168.1.18/24 | vEOS-LAB | Provisioned | - |
...
| ---- | ---- | -------------- | --------- | ----------| -------------- |
| l3leaf | site1-border1 | Ethernet1 | overlay-controller | site1-rs1 | Ethernet1 |
...
| l3leaf | site1-border2 | Ethernet2 | overlay-controller | site1-rs1 | Ethernet2 |
...
| 20.0.1.0/24 | 256 | 4 | 1.57 % |

### Point-To-Point Links Node Allocation

| Node | Node Interface | Node IP Address | Peer Node | Peer Interface | Peer IP Address |
| ---- | -------------- | --------------- | --------- | -------------- | --------------- |
| site1-border1 | Ethernet1 | 20.0.1.9/31 | site1-rs1 | Ethernet1 | 20.0.1.8/31 |
...
| site1-border2 | Ethernet2 | 20.0.1.11/31 | site1-rs1 | Ethernet2 | 20.0.1.10/31 |
