...
| ------------ | --------------------------------- | ------------------------- | ---- | ------------------- | ---------- | ---------- |
| FLOW-TRACKER | 70000 | 5000 | - | 1 | Ethernet2<br>Ethernet3<br>Ethernet4 | - |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_site1-rs1_Ethernet2 | - | 20.0.1.11/31 | default | 9214 | False | - | - |
...
| 20.0.1.10 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 172.16.20.99 | 65101 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 20.0.1.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 20.0.1.10 remote-as 65101
   neighbor 20.0.1.10 description site1-rs1_Ethernet2
   neighbor 172.16.20.99 peer group EVPN-OVERLAY-PEERS
   neighbor 172.16.20.99 remote-as 65101
   neighbor 172.16.20.99 description site1-rs1_Loopback0
