...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_site4-spine1_Ethernet1 | - | 10.0.6.25/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_site4-spine1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
   flow tracker sampled FLOW-TRACKER
   ip address 10.0.6.25/31
!
interface Ethernet5
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.6.24 | 65105 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65104
   ...
   neighbor 10.0.6.24 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.6.24 remote-as 65105
   neighbor 10.0.6.24 description site4-spine1_Ethernet1
