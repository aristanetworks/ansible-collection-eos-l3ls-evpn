...
| ------------ | --------------------------------- | ------------------------- | ------------------- | ---------- |
| FLOW-TRACKER | 70000 | 5000 | 1 | Dps1<br>Ethernet1<br>Ethernet3<br>Ethernet4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_site4-spine1_Ethernet3 | - | 10.0.4.29/31 | default | 9214 | False | - | - |
| Ethernet3 | ACME-MPLS-INC_mpls-site4-wan1_mpls-cloud_Ethernet5 | - | 172.18.40.2/24 | default | - | False | - | - |
| Ethernet4 | REGION3-INTERNET-CORP_inet-site4-wan1_inet-cloud_Ethernet5 | - | 100.64.40.2/24 | default | - | False | ACL-INTERNET-IN_Ethernet4 | - |
...
!
interface Ethernet1
   description P2P_site4-spine1_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 10.0.4.29/31
!
interface Ethernet3
   description ACME-MPLS-INC_mpls-site4-wan1_mpls-cloud_Ethernet5
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
...
!
interface Ethernet4
   description REGION3-INTERNET-CORP_inet-site4-wan1_inet-cloud_Ethernet5
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.4.28 | 65105 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 192.168.42.16 | 65000 | default | - | all | - | - | - | - | True | - | - |
| 192.168.255.17 | 65105 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
| -------- | -------- | ------------ | ------------- | ------------- | ------------------------------ |
| 192.168.42.16 | True | - | - | path-selection | - |
...
router bgp 65000
   ...
   neighbor 10.0.4.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.4.28 remote-as 65105
   neighbor 10.0.4.28 description site4-spine1_Ethernet3
   ...
   neighbor 192.168.42.16 remote-as 65000
   neighbor 192.168.42.16 update-source Dps1
   neighbor 192.168.42.16 description site4-wan2
   neighbor 192.168.42.16 route-reflector-client
   neighbor 192.168.42.16 route-map RM-WAN-HA-PEER-IN in
   neighbor 192.168.42.16 route-map RM-WAN-HA-PEER-OUT out
   neighbor 192.168.42.16 send-community
   neighbor 192.168.255.17 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.17 remote-as 65105
   neighbor 192.168.255.17 description site4-spine1_Loopback0
   ...
   address-family evpn
      ...
      neighbor 192.168.42.16 activate
      neighbor 192.168.42.16 encapsulation path-selection
...
| 20 | permit 192.168.42.15/32 eq 32 |

##### PL-WAN-HA-PEER-PREFIXES

| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.0.4.30/31 |

##### PL-WAN-HA-PREFIXES

| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.0.4.28/31 |
...
ip prefix-list PL-LOOPBACKS-EVPN-OVERLAY
   ...
   seq 20 permit 192.168.42.15/32 eq 32
!
ip prefix-list PL-WAN-HA-PEER-PREFIXES
   seq 10 permit 10.0.4.30/31
!
ip prefix-list PL-WAN-HA-PREFIXES
   seq 10 permit 10.0.4.28/31
```
...
| 40 | permit | - | extcommunity soo 192.168.255.15:301 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 192.168.255.15:301 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 192.168.255.15:301 additive | - | - |
...
route-map RM-BGP-UNDERLAY-PEERS-IN permit 40
   ...
   set extcommunity soo 192.168.255.15:301 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 192.168.255.15:301 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.255.15:301
```
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 192.168.42.16 | site4-wan2 | 10.0.4.31 |
...
router path-selection
   ...
   path-group LAN_HA id 65535
      ...
      !
      peer static router-ip 192.168.42.16
         name site4-wan2
         ipv4 address 10.0.4.31
   !
