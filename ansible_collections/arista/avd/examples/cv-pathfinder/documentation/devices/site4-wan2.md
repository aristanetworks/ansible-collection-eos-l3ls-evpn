...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_site4-spine1_Ethernet4 | - | 10.0.4.31/31 | default | 9214 | False | - | - |
| Ethernet3 | ACME-MPLS-INC_mpls-site4-wan2_mpls-cloud_Ethernet6 | - | 172.18.41.2/24 | default | - | False | - | - |
| Ethernet4 | REGION3-INTERNET-CORP_inet-site4-wan2_inet-cloud_Ethernet6 | - | dhcp | default | - | False | ACL-INTERNET-IN_Ethernet4 | - |
...
!
interface Ethernet1
   description P2P_site4-spine1_Ethernet4
   no shutdown
   mtu 9214
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 10.0.4.31/31
!
interface Ethernet3
   description ACME-MPLS-INC_mpls-site4-wan2_mpls-cloud_Ethernet6
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
...
!
interface Ethernet4
   description REGION3-INTERNET-CORP_inet-site4-wan2_inet-cloud_Ethernet6
   no shutdown
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address dhcp
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.0.4.30 | 65105 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 192.168.42.15 | 65000 | default | - | all | - | - | - | - | True | - | - |
...
| -------- | -------- | ------------ | ------------- | ------------- | ------------------------------ |
| 192.168.42.15 | True | - | - | path-selection | - |
...
router bgp 65000
   ...
   neighbor 10.0.4.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.0.4.30 remote-as 65105
   neighbor 10.0.4.30 description site4-spine1_Ethernet4
   ...
   neighbor 192.168.42.15 remote-as 65000
   neighbor 192.168.42.15 update-source Dps1
   neighbor 192.168.42.15 description site4-wan1
   neighbor 192.168.42.15 route-reflector-client
   neighbor 192.168.42.15 route-map RM-WAN-HA-PEER-IN in
   neighbor 192.168.42.15 route-map RM-WAN-HA-PEER-OUT out
   neighbor 192.168.42.15 send-community
   ...
   address-family evpn
      ...
      neighbor 192.168.42.15 activate
      neighbor 192.168.42.15 encapsulation path-selection
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 192.168.42.15 | site4-wan1 | 10.0.4.29 |
...
router path-selection
   ...
   path-group LAN_HA id 65535
      ...
      !
      peer static router-ip 192.168.42.15
         name site4-wan1
         ipv4 address 10.0.4.29
   !
